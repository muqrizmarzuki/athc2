...
<body>
    <main class="main-wrapper">
        <header class="header"><div class="w-layout-blockcontainer container-default navbar-container w-container"><div class="navbar-pages-wrapper w-nav" data-animation="over-left" data-collapse="medium" data-doc-height="1" data-duration="400" data-easing="ease" data-easing2="ease" role="banner"><div class="navbar-content-wrapper"><a aria-current="page" class="navbar-brand w-nav-brand w--current" href="#home" style="display: flex; align-items: center; padding: 2px 0;"><img src="{{ asset('assets/images/Primary-Logo-Trimmed.png') }}" alt="AHTC Logo" style="height: 56px; max-height: 60px; width: auto; object-fit: contain;"></a><nav class="nav-menu-wrapper w-nav-menu" role="navigation"><ul class="nav-menu-list-wrapper" role="list"><li class="nav-menu-item-wrapper mobile-menu-logo-wrapper"><a aria-current="page" class="navbar-brand w-nav-brand w--current" href="#home"><img src="{{ asset('assets/images/Secondary-Logo-Trimmed.png') }}" alt="AHTC Logo" style="height: 50px; width: auto; object-fit: contain;"></a></li><li class="nav-menu-item-wrapper"><a aria-current="page" class="nav-menu-link top-menu-link w--current" href="#home">Home</a></li><li class="nav-menu-item-wrapper"><a class="nav-menu-link top-menu-link" href="#about">About Us</a></li><li class="nav-menu-item-wrapper"><a class="nav-menu-link top-menu-link" href="#solutions">Training &amp; Solutions</a></li><li class="nav-menu-item-wrapper"><a class="nav-menu-link top-menu-link" href="#contact">Contact Us</a></li><li class="nav-menu-item-wrapper mobile-menu-nav-cta"><a class="primary-button mobile-menu-cta w-inline-block" href="#contact"><p class="button-text">Get In Touch</p></a></li></ul></nav><div class="menu-button w-nav-button"><div class="menu-icon w-icon-nav-menu"></div></div><div class="navbar-cta-wrapper"><a class="primary-button w-inline-block" href="#contact"><p class="button-text">Get In Touch</p></a></div></div></div></div></header>
